...
from apps import quality_manage as qualityCheck
...
class quality(unittest.TestCase):
    ...
    def test_04(self):
        ...
        elkLog = elkSearch.elkSoftware(sourceId, self.method)
        self.assertEqual(0, res.json()['code'])
        self.assertEqual("sourceId字段不能为空", elkLog['exceptionContent'], elkLog)
    ...
    def test_05(self):
        ...
        elkLog = elkSearch.elkSoftware(sourceId, self.method)
        self.assertEqual(0, res.json()['code'])
        self.assertEqual("checkDate字段不能为空", elkLog['exceptionContent'], elkLog)
    ...
    def test_16(self):
        ...
        pdata = qualityCheck.JSONV2_Request(self.ProjectSysNo)
    ...
    def test_21(self):
        "推送正式项目数据- 项目未添加应用"
        data = qualityCheck.JSONV2_Request(10)
        sourceId = data['sourceId']
        data = json.dumps(data)
        res = OpenAPI(method=self.method, data=data)
